...
const questions = [
  ...
  { id: 4, text: 'Miten tärkeänä pidät sitä, että perheellä on taloudellista turvaa yllättävien terveyshaasteiden varalle jo ennen lapsen syntymää?', options: ['Erittäin tärkeänä', 'Kohtalaisen tärkeänä', 'En niin tärkeänä'] },
